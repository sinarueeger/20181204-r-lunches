...
- In the past: I worked as a research assistant in a data science environment, in epidemiology and in statistical genetics. 
...
### 1. Getting the data analysis done.
...
code can be misunderstood for two reasons: bad styling, bad coding
...
- [`library(lintr)`](https://github.com/jimhester/lintr) 
---
class: left, middle

### `library(formatr)`

Some more details on [Yihui Xie page](https://yihui.name/formatr/) and make sure you read *6. Further Notes* on what bad can happen. 
